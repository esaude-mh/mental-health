...
public class DateExportReport extends MhDataExportManager {
    ...
    private DataSetDefinition dataSetDefinition() {
        ...
        dsd.addColumn("diagnosisI", getObs(MentalHealthEncounterTypes.INITIAL_ENCOUNTER_TYPE.uuid(), MhConstants.DIAGNOSIS_CONCEPT), "", new ObsDataConverter());
        dsd.addColumn("other1", other1(), "", new ObsDataConverter());
        dsd.addColumn("visit", followUp(), "", new EncounterDatetimeForVisitConverter());
        dsd.addColumn("diagnosisF", getObs(MentalHealthEncounterTypes.FOLLOW_UP_ENCOUNTER_TYPE.uuid(), MhConstants.DIAGNOSIS_CONCEPT), "", new ObsDataConverter());
        dsd.addColumn("consultation-date", followUp(), "", new EncounterDatetimeForVisitConverter());
        ...
        dsd.addColumn("gravity", getObs(MentalHealthEncounterTypes.FOLLOW_UP_ENCOUNTER_TYPE.uuid(), MhConstants.GRAVITY), "", new ObsDataConverter());
        dsd.addColumn("suicide", getObs(MentalHealthEncounterTypes.FOLLOW_UP_ENCOUNTER_TYPE.uuid(), MhConstants.SUICIDAL_F2), "", new ObsDataConverter());
