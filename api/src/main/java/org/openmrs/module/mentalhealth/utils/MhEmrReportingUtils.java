...
public class MhEmrReportingUtils {
    ...
    public static void addRow(CohortIndicatorDataSetDefinition cohortDsd, String baseName, String baseLabel,
                              Mapped<CohortIndicator> indicator, List<MhColumnParameters> columns) {
     ...
     */
    public static void addRow(CohortIndicatorDataSetDefinition cohortDsd, String baseName, String baseLabel,
                              Mapped<CohortIndicator> indicator, List<MhColumnParameters> columns, List<String> columnNames) {
        int c = 0;
        for (MhColumnParameters column : columns) {
