...
@Component
public class DateExportInitialReport extends MhDataExportManager {
    ...
    public static final String REPORT_NAME = "Data Export Initial Form";
    @Override
